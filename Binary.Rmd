...
ocdt <- tibble(CtrlRate = ctrl_range, Freq_Error = 0.025, rMAP_Error = round(error_rmap,3), oMAP_Error = round(error_omap,3), 
               Freq_Power = round(FPwr20$power,3), rMAP_Power = round(power_rmap,3), oMAP_Power = round(power_omap,3))
